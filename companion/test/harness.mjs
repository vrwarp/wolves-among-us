...
export const FIELDS = ["round","targetPts","deaths","threshold","imposters","sabotageMax","sabProps",
  "impostersCaught","sabotagesUsed","sabItems","banner","paused","timer","phase","meet"];
