...
build("footprints-print-pack/01-index-cards/index-cards-32-unique.pdf",uniq+([None] if len(uniq)%2 else []))
deck=uniq*3
build("footprints-print-pack/01-index-cards/index-cards-96-deck.pdf",deck,
