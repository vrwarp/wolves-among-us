...
PW,PH=letter
ROLES=[
("CENTRAL COMMAND","Counselor 4  ·  the lobby desk","THE CLOCK AND THE MEETINGS",
 [("WHERE YOU STAND",["The lobby desk. You do not leave it."]),
  ("YOUR ONE JOB",["Run the clock and moderate every meeting. Be ruthless about the 3-minute hard stop.",
  ...
  ("MEETINGS — 3 minutes, hard stop",
   ["There is no button. A meeting happens ONLY when someone finds a body",
    "and yells EMERGEN-C in the lobby.",
  ...
  ("WHAT YOU VERIFY",["Anything portable, from the desk: door codes, Bible pages, mazes, sudoku, gospel cards.",
                      "You are one end of the RED BALL delivery. Take the ball, stamp, drop it in the bowl.",
  ...
  ("RULINGS",["Mark kills and crewmate ejections on the board. Ejected imposters are free.",
              ...
              "Run Sabotage from its own page."])]),
("FOREMAN","Counselor 3  ·  the stage area","STAMP FAST, THEN MAKE THEM RESET",
 [("WHERE YOU STAND",["The stage area. Cups, apples and the flight zone."]),
  ("YOUR ONE JOB",["Verify and stamp instantly, then make the student reset the station before they leave.",
...
("ROAMING REFEREE","Counselor 2  ·  upstairs","BREAK UP THE PACKS",
 [("WHERE YOU STAND",["Upstairs, moving. The upstairs floor is yours. Central Command covers downstairs."]),
  ...
  ("RULINGS",["You do NOT need to keep moving to keep the floor dangerous.",
              ...
              "A student who runs: verbal warning, then cross out one stamp box and initial it.",
...
("GHOST GUIDE","Counselor 1  ·  the dead room","KEEP IT QUIET, KEEP IT FOLDING",
 [("WHERE YOU STAND",["The dead room, near the door. High School boys room."]),
  ...
  ("WHAT YOU VERIFY",["ORIGAMI   ·   GREEN 2 pts   ·   BLUE 3 pts",
                      ...
                      "You are one end of the RED BALL delivery. Take the ball at the DOORWAY, stamp, bowl it.",
  ...
  ("RULINGS",["Ghosts do NOT attend meetings. They stay here the whole round.",
              ...
              "You also hold the PHASE stopwatch — 3-minute meeting phases, the 2-minute Sabotage scramble."])]),
("ALL COUNSELORS","Read this before the doors open","THE FIVE THINGS THAT MATTER",
 [("SAFETY",["NO RUNNING. One foot on the ground at all times, everyone, always. Enforce it hardest",
  ...
  ("VERIFYING",["Four distinct stamps or markers, one per counselor — the four must be",
                "unmistakably different. Keep yours on you; never set it down where a student can take it.",
                "Your stamp is final. No appeals.",
  ...
  ("THE GAME",["Everyone carries a spoon, so nobody can be identified as an imposter by carrying one.",
               "“Can I see your card?” is allowed. Imposters collect real stamps, so a card proves nothing.",
