 ...
 [("WHERE YOU STAND",["By the TV, where you can see the monitor. Students never come to you.",
  ...
  ("THE CLOCK — one stopwatch, counting DOWN",
   ["Start at 8:00 of floor time when the first 60 seconds are up.",
    ...
    "Sabotage succeeds: +1:00.   Sabotage fails: −1:30 and +2 deaths.   Imposter caught: +1:00.",
  ...
  ("RULINGS",["Sabotage starts at a kiosk (anonymous) or by a tap on any counselor.",
    "Any role can pause the game.",
    "A meeting cannot end with nobody ejected. Called one by mistake? That is an Undo — yours.",
 ...
 [("WHERE YOU STAND",["The lobby desk. You do not leave it. You are in the game — students come to you."]),
  ...
  ("MEETINGS — 3 minutes, hard stop",
   ["There is no button. A meeting happens ONLY when someone finds a body",
    ...
    "                   Not one name by 2:00? The finder of the body names one. Somebody is going out.",
    "2:00–2:30  THE CORNERS. Nominees to separate corners, 15 seconds each to answer.",
    "2:30–3:00  THE VOTE. “Ten seconds. Every corner is a name — stand in one. There is no skip.”",
    "                   Still drifting at zero, you lose your vote. Largest corner wins.",
    "                   TIE = EVERY TIED NOMINEE GOES. Two corners level, two students are ejected.",
    "Reveal every ejection on the spot. Crewmate: out, NO tick. Imposter: caught, +1:00 each."]),
  ...
  ("RULINGS",["Every meeting ejects somebody: tap the app once per name, then Close the meeting.",
              "Mark kills on the board. Ejections never tick it — a caught imposter pays the crew +1:00.",
...
("FOREMAN","Counselor 3  ·  the stage area","MARK FAST, THEN MAKE THEM RESET",
 [("WHERE YOU STAND",["The stage area. Cups, apples and the flight zone."]),
  ...
  ("RULINGS",["Students may talk each other through a task. They may not do it FOR them.",
              ...
              "Any imposter can tap YOU to start a Sabotage — and the kiosks fire on their own."])]),
...
("GHOST GUIDE","Counselor 1  ·  the dead room","KEEP IT QUIET, KEEP IT FOLDING",
 [("WHERE YOU STAND",["The dead room, near the door. High School boys room."]),
  ...
  ("RULINGS",["Ghosts do NOT attend meetings. They stay here the whole round.",
              ...
              "Every meeting sends you at least one new ghost, and a tied vote sends several at once.",
...
("ALL COUNSELORS","Read this before the doors open","THE FIVE THINGS THAT MATTER",
 [("SAFETY",["NO RUNNING. One foot on the ground at all times, everyone, always. Enforce it hardest",
  ...
  ("THE GAME",["Everyone carries a spoon, so nobody can be identified as an imposter by carrying one.",
               ...
               "Every meeting ejects somebody — you vote on WHO, never on whether. A tie ejects all tied.",
               "Ejections are revealed on the spot, and none of them tick the death count.",
