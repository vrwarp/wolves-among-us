...
others=set(os.listdir('footprints-print-pack'))-{'01-index-cards','02-sudoku','05-doors','06-signs','07-counselor','08-sabotage'}
chk(others=={'PRINT-ME-FIRST.md','among-us-footprints.pptx'}, f"pack root holds only guide + deck: {sorted(others)}")
...
print("\n== 4. INK-MARGIN AUDIT ==")
r=subprocess.run(['python3','audit_margins.py'],capture_output=True,text=True).stdout
